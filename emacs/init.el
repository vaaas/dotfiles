...
(define-key my-keys-minor-mode-map (kbd "M-J") (lambda() (interactive) (forward-paragraph) (next-line)))
(define-key my-keys-minor-mode-map (kbd "M-K") (lambda() (interactive) (backward-paragraph) (backward-paragraph) (next-line)))
...
(define-key my-keys-minor-mode-map (kbd "C-z e s") 'eshell)
