...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ortho_3x10( // base layer
		KC_G,    KC_C,    KC_D,    KC_H,    KC_RALT, KC_LGUI, KC_W,    KC_U,    KC_O,    KC_X,
	...
	[1] = LAYOUT_ortho_3x10( // alpha 2 layer
		KC_Q,    KC_K,    KC_P,    KC_V,    _______, _______, KC_QUOT, KC_MINS, KC_BSLS, KC_GRV,
		KC_Z,    KC_F,    KC_B,    KC_M,    _______, _______, KC_Y,    KC_J,    KC_COMM, KC_DOT,
	...
	[2] = LAYOUT_ortho_3x10( // sys layer
		...
		_______, _______, _______, _______, _______, _______, MO(3),   _______, _______, QK_BOOT
	),
