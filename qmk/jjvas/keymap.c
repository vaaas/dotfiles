...
_______, KC_DEL , KC_BSPC, KC_TAB , KC_ENT , _______, _______, KC_LBRC, KC_RBRC, _______, KC_BSLS, KC_F12 , \
KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY, KC_ESC , KC_INS , KC_ESC , _______, KC_MPRV, KC_BRID, KC_BRIU, KC_MNXT  \
),
};
