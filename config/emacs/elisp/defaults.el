...
(cond
	((eq prefers-colour-scheme 'light)
		...
		'(font-lock-type-face ((t (:foreground "#dd3388"))))
	...
	((eq prefers-colour-scheme 'dark)
		...
		'(eshell-prompt ((t (:foreground "#ff0055" :weight bold))))
		'(font-lock-builtin-face ((t (:underline (:color foreground-color)))))
		'(font-lock-comment-face ((t (:foreground "#ff8844"))))
		'(font-lock-constant-face ((t (:inherit font-lock-type-face))))
		'(font-lock-function-name-face ((t (:foreground "#88aaff" :weight bold))))
		'(font-lock-keyword-face ((t (:weight semi-bold))))
		'(font-lock-string-face ((t (:foreground "#00ff88"))))
		'(font-lock-type-face ((t (:foreground "#ff88aa"))))
		'(font-lock-variable-name-face ((t nil)))
		'(fringe ((t nil)))
		'(highlight ((t (:background "#004488"))))
		'(isearch ((t (:background "#4488ff" :foreground "#ffeedd"))))
		'(lazy-highlight ((t (:inherit highlight))))
		'(link ((t (:inherit font-lock-function-name-face))))
		'(minibuffer-prompt ((t (:foreground "#ff0055"))))
		'(mmm-default-submode-face ((t nil)))
