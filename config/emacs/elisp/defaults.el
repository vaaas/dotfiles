...
(custom-set-faces
	'(default ((t (:inherit nil :extend nil :stipple nil :background "#fed" :foreground "black" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 160 :width normal :family "Monospace"))))
